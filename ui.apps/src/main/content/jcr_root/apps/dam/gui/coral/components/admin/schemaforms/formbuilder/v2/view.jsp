...
%><cq:defineObjects /><%
    ...
    String formFieldsPath = cfg.get("formfields", "dam/gui/coral/components/admin/schemaforms/formbuilder/formfields");
...
*/
    List<Resource> masterTabList = SchemaFormHelper.getPrimaryForms(rsc);
